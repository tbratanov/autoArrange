...
export declare namespace Glue42 {
    ...
    export interface Config extends Glue42Core.Config {
         ...
         * @default "slim"
         */
        layouts?: boolean | Glue42.Layouts.Mode | Glue42.Layouts.Configuration;
    ...
    namespace AppManager {
        ...
        export interface ShuttingDownEventArgs {
            restarting: boolean;
            initiator?: Glue42.Interop.Instance;
            reason?: string;
        }
    ...
    namespace Displays {
        ...
        export interface API {
             ...
             */
            onDisplayChanged(cb: (displays: Glue42.Displays.Display[]) => void): UnsubscribeFunction;
        }
    ...
    namespace Layouts {
         ...
         * The `"Activity"` and `"Swimlane"` types are legacy Layout types and shouldn't be used.
        ...
        export interface Configuration {
             ...
             * @default false
             */
            autoSaveWindowContext: boolean | LayoutType[];
        }
        ...
        export interface NewLayoutOptions {
            ...
            /** 
             * Deprecated. Only if the layout type is `Global`. If `true` (default), the layout will not include hidden apps.
             * @ignore
             */
            ignoreHidden?: boolean;

            /** 
             * Deprecated. Only if the layout type is `Global`. Ignores the current instance when saving a layout. `False` by default.
             * @ignore
             */
        ...
        export interface RestoreOptions {
            ...
            /**
            * Only if the type is `Global`. If `false`, will not close all visible running instances before restoring the layout.
            * Exceptions are applications which are configured as shell, service, autoStart, ignoreFromLayouts (Glue42 Toolbar is shell).
            * The default is `true`.
            */
            closeRunningInstances?: boolean;

            /**
             * If `true`, will close the current application.
             * If `closeRunningInstance`is set to `false, `closeMe`s default will change to `false` too.
             * @default true
             */
            closeMe?: boolean;
            ...
            */
            ...
            /**
             * Deprecated. Only if the type is `Activity` and `activityId` is set. If `true`, will restore the activity owner window.
             * @ignore
             */
            restoreActivityOwner?: boolean;

            /**
            * Deprecated. Restore options for the splash screen.
            * @ignore
            */
    ...
    namespace Windows {
        ...
        export interface WindowSettings {
             ...
             * Possible options are `center`, `topCenter`, `bottomCenter`, `leftCenter`, `rightCenter`, `full`, `topFull`, `bottomFull`, `leftFull`, `rightFull`.
             */
    ...
    export namespace Preferences {
        ...
        export interface API {
             ...
             * @param app Name of the application whose preferences will be replaced. To replace the preferences for the current app, use the `set()` method.
             * @param data New data to replace the existing preferences.
             */
             ...
             * @param app Name of the application whose preferences will be updated. To update the preferences for the current app, use the `update()` method.
             * @param data Data to be merged with the existing preferences.
             */
            ...
            * @param app - if specified will clear preferences of another application
            */
             ...
             * @param callback The callback will be invoked with the initial value and on every change of the preferences.
             * @returns Unsubscribe function.
             * @since Glue42 3.14
             */
            subscribe(callback: (prefs: AppPreferences) => void): () => void;

            /**
             * Subscribe for changes to the preferences of a specified app.
             * @param app Name of the application for which to subscribe.
             * @param callback The callback will be invoked with the initial value and on every change of the preferences.
             * @returns Unsubscribe function.
             * @since Glue42 3.14
             */
            subscribeFor(app: string, callback: (prefs: AppPreferences) => void): () => void;
        }
